    ...
    <div class="card">
      <figure class="rollover">
        ...
        <div class="card-body text-left">
            ...
            <p class="card-text content-height">{{ post.content}}</p>
        </div>
        <div class="card-footer d-flex justify-content-between">
            <span class="item item-category">{{post.mainCategory}}</span>
            <span class="item item-sold"> Likes: <strong>{{ post.likes }}</strong></span>
        </div>
    </div>
